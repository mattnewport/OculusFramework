...
struct HeightField {
    ...
    void Render(DirectX11& dx11, ID3D11DeviceContext* context, ID3D11Buffer& cameraBuffer, ID3D11ShaderResourceView& pmremEnvMapSRV, ID3D11ShaderResourceView& irradEnvMapSRV, ID3D11SamplerState& cubeSampler);
};
